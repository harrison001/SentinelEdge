...
echo "[INFO] Quick Symbol Matching Feasibility Check"
echo "=============================================="
echo "NOTE: This script checks if your production environment is suitable for symbol matching debugging"
echo ""
...
echo "[STEP] 1. Kernel Basic Information"
echo "=================================="
...
echo ""
echo "[STEP] 2. Kernel Configuration Check"
echo "===================================="
...
# 3. Check compiler
echo ""
echo "[STEP] 3. Compilation Environment Check"
echo "======================================"
...
echo ""
echo "[STEP] 4. Symbol Table Access Check"
echo "==================================="
...
echo ""
echo "[STEP] 5. Debugging Tools Check"
echo "==============================="
...
# 6. Summary report
echo ""
echo "[RESULT] Overall Assessment Report"
echo "=================================="
...
if [ $PERCENTAGE -ge 80 ]; then
    ...
    log_warning "Environment basically suitable, but may need some preparation"
